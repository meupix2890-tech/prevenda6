  ...
  return (
    <div className="min-h-screen bg-[#0070d1] text-white" style={{ fontFamily: "'SST', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#3b1a5c] via-[#6b2d8a] to-[#c44a7a]">
        {/* Imagem de fundo (mobile e desktop) */}
        <img src={heroImg} alt="Grand Theft Auto VI" width={1920} height={1080} className="absolute inset-0 w-full h-full object-cover object-right opacity-80 md:opacity-70" />
        <div className="absolute inset-0 bg-gradient-to-r from-black/85 via-black/55 to-black/20 md:from-black/80 md:via-black/40 md:to-transparent" />
        ...
        <div className="relative max-w-[1440px] mx-auto px-6 pt-12 pb-16 md:pt-16 md:pb-24 min-h-[680px] md:min-h-[680px] flex flex-col justify-center">
      ...
      <section className="bg-gray-100 text-black py-16">
        <div className="max-w-[900px] mx-auto px-6">
          ...
          <div className="bg-white rounded-lg p-8 border mb-6">
            ...
            <div className="flex items-center gap-4 mb-2">
              ...
              <div>
                ...
                <p className="text-xs opacity-70 mt-1">Baseado em 12.847 avaliações</p>
              </div>
            </div>
            <div className="space-y-1 mt-4 text-sm">
              {[
                ...
                <div key={r.s} className="flex items-center gap-2">
                  <span className="w-3">{r.s}</span>
                  <span className="text-yellow-500">★</span>
                  <div className="flex-1 h-2 bg-gray-200 rounded overflow-hidden">
                    <div className="h-full bg-yellow-500" style={{ width: `${r.p}%` }} />
                  </div>
                  <span className="w-10 text-right text-xs opacity-70">{r.p}%</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-4">
            {[
              { name: "Lucas M.", date: "há 2 dias", stars: 5, title: "Simplesmente perfeito", text: "Vice City nunca esteve tão viva. Cada detalhe gráfico no PS5 Pro é absurdo, e a história entre Jason e Lucia te prende do início ao fim. Rockstar entregou o jogo da geração." },
              { name: "Bianca R.", date: "há 5 dias", stars: 5, title: "Vale cada centavo", text: "Comprei a Ultimate Edition e não me arrependo. O mapa é gigantesco, a física dos veículos é impressionante e a trilha sonora é viciante. 100h e mal arranhei a superfície." },
              { name: "Rafael T.", date: "há 1 semana", stars: 4, title: "Obra-prima com pequenos bugs", text: "Jogo incrível, mas tive alguns bugs em missões secundárias. Nada que tire o brilho. A IA dos pedestres é o melhor que já vi em um GTA." },
              { name: "Carla S.", date: "há 2 semanas", stars: 5, title: "Imersão total com DualSense", text: "A resposta tátil e o áudio 3D fazem diferença absurda. Sentir cada tiro, cada freada... parece outro jogo. Recomendo demais." },
              { name: "Diego P.", date: "há 3 semanas", stars: 5, title: "Rockstar é outro nível", text: "Esperei 13 anos e valeu. Modo história denso, personagens carismáticos e mundo aberto vivo. GOTY com folga." },
            ].map((rev) => (
              <div key={rev.name} className="bg-white rounded-lg p-6 border">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs opacity-60">{rev.date}</p>
                    </div>
                  </div>
                  <div className="text-yellow-500 text-sm">{"★".repeat(rev.stars)}{"☆".repeat(5 - rev.stars)}</div>
                </div>
                <h4 className="font-semibold text-sm mb-1">{rev.title}</h4>
                <p className="text-sm opacity-80 leading-relaxed">{rev.text}</p>
              </div>
            ))}
          </div>
